...
def objective_ga_pygad(ga_instance, solution, solution_idx):
	...
	descriptors = {'NAC': list(range(0, 4)), 'DNC': list(range(4, 20)),
				   'TNC': list(range(20, 84)), 'kGap_di': list(range(84, 148)),
				   'ORF': list(range(148, 158)), 'Fickett': list(range(158, len(df_x.columns)))}
 
 
	desc = ['NAC', 'DNC', 'TNC', 'kGap_di', 'ORF', 'Fickett']
...
def objective(trial, train, train_labels):
	...
	descriptors = {'NAC': list(range(0, 4)), 'DNC': list(range(4, 20)),
				   'TNC': list(range(20, 84)), 'kGap_di': list(range(84, 148)),
				   'ORF': list(range(148, 158)), 'Fickett': list(range(158, len(train.columns)))}
...
if __name__ == '__main__':
	...
	parser.add_argument('-estimations', '--estimations', default=30, help='number of estimations - BioAutoML - default = 50')
